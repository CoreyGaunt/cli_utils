...
def init_cliutils():
    """
    This command is used to create a .cliutils directory in the root of the project.
    Then it will create a cliutils-config.yaml file in the .cliutils directory.
    """
    utils.check_and_install_terminal_requirements()
    config_location = Path.home() / ".cliutils"
    ...
    with open(f"{config_location}/cliutils-config.yaml", "w") as file:
        ...
        file.write("  - __init__\n")
    console.print("Initialized .cliutils Directory", style="bold green")
